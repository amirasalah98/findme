...
import { MISSING_DATA } from "../constants/mockData"
import { ListingScreen } from "../components/listing/ListingScreen"
import type { NavProps } from "../types"
import { PageWrap } from "../components/common/PageWrap"


export function MissingPeopleScreen({ nav }: NavProps) {
  ...
  return (
    <>
      <ListingScreen
        ...
        subtitle="Browse reports of people who have been reported missing."
        reportLabel="Report Missing Person"
        reportBg={C.navy}
        data={MISSING_DATA}
        filterLabels={[
          "Location",
